...
from .views import (gradeview,course_quizzes_grade_api,semester_course_grade_api,
                                semester_course_grade_view,midterm_grade,midterm_grade_api,
                                ...
                                student_questions,course_questions,update_question,delete_question,create_question,
                                get_answers,create_answer,update_answer,delete_answer)

#TODO:fix all urls make them look good
...
urlpatterns = [
    ...
    path('student/questions/all/',student_questions,name='student-questions-api'),
    path('course/<course_code>/questions/',course_questions,name='course-questions-api'),
    path('course/<course_code>/question/',create_question,name='create-question-api'),
    path('question/<slug:slug>/update/',update_question,name='update-question-api'),
    path('question/<slug:slug>/delete/',delete_question,name='delete-question-api'),
    path('student/course/question/answers/all/',get_answers,name='student-answers'),
    path('question/<slug:question_slug>/answer/create',create_answer,name='create-answer-api'),
    path('question/<slug:slug>/update/',update_answer,name='update-answer-api'),
    path('question/answer/<slug:slug>/delete',delete_answer,name='delete-answer-api')
]
